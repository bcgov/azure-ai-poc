...
- [x] app/auth/service.py (refactored, multi-issuer)
- [x] app/auth/models.py (EntraUser with roles)
- [x] app/auth/dependencies.py (updated for Entra)
- [x] app/auth/role_mapping.py (new, provider role normalization)
- [x] app/config.py (Entra config + feature flags)
- [x] app/middleware/auth_middleware.py (logging)
- [x] app/routers/metrics.py (new, auth metrics)
- [x] tests/test_auth_*.py (4 test files)
- [x] pyproject.toml (PyJWT added)
- [x] README.md (updated with Entra section)

**Frontend**: frontend/
- [x] src/env.ts (new, Entra config)
- [x] src/service/auth-service.ts (new, MSAL.js)
- [x] src/service/api-client.ts (new, token injection)
- [x] src/components/AuthProvider.tsx (new)
- [x] src/components/LoginButton.tsx (new)
- [x] src/components/ProtectedRoute.tsx (new)
- [x] src/main.tsx (updated with AuthProvider)
- [x] src/__tests__/auth.test.ts (new)
- [x] e2e/auth.spec.ts (new, Playwright)
- [x] package.json (MSAL libs added)
- [x] ENTRA_ID_SETUP.md (new)
...
- [x] MIGRATION_CHECKLIST.md (new)
- [x] ROLLBACK.md (new)
- [x] MIGRATION_RUNBOOK.md (new)
- [x] SECURITY_CHECKLIST.md (new)

**Documentation**: /
- [x] README.md (updated with Entra auth section)
- [x] .env.example (new, Entra vars)
- [x] docs/ENTRA_ID_TROUBLESHOOTING.md (new)
