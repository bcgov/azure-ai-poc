...
- Python 3.13 (backend), TypeScript 5.x (frontend) (001-migrate-entraid-auth)
- N/A for auth (no persistence of auth data; identity providers remain source-of-truth) (001-migrate-entraid-auth)
...
## Recent Changes
- 001-migrate-entraid-auth: Added Python 3.13 (backend), TypeScript 5.x (frontend)
